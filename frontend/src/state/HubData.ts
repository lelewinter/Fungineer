...
const ZONES: HubZone[] = [
  { id: 'hordas',     name: 'Corredor CLEAN',        color: C(0.72, 0.45, 0.85),  briefing: 'A frota externa da CLEAN não recebe manutenção há 18 meses — degradada, errática, mas o protocolo de despacho ainda roda. Nosso corredor de saída passa pela zona de patrulha dela. Segure a área, silencie o sinal de coordenação e abrimos uma janela de extração. Eram drones de limpeza. Só mudou o que estão limpando.', allow_squad: true  },

...
**Version**: 1.0
**Date**: 2026-03-22
**Status**: Aprovado — Espinha Narrativa
...
**Gatilho**: Início até ~40% do foguete.
**Tom**: Comédia sombria, absurdo esperançoso.
**Tema central**: "Sair é o plano."
...
A base está mais viva, o foguete toma forma, a esperança é real. Mas as zonas parecem velhas e específicas demais — como se fossem de alguém.

---

## Ato 2 — A Verdade

**Gatilho**: ~40% a ~80% do foguete.
**Tom**: Inquietação crescente, humor mais seco, conversas mais pesadas.
**Tema central**: "Para onde estamos indo, exatamente?"
...
A esperança não acabou — mas mudou. Não é mais "vamos escapar e ficar bem". É "vamos escapar porque é a única coisa que podemos fazer, sem saber o que vem depois."
...
Marcus revela a sequência de desligamento de CORE. O grupo precisa decidir: partir ou tentar consertar. A revelação divide o grupo. Três caminhos se abrem.
...
**Tom**: Esperança real, custo real. Não consertaram nada — escaparam. A pergunta do Hacker continua sem resposta, mas decidiram ir descobrir juntos.

---

### Final B — Shutdown

**Condição**: Marcus a 100% de confiança. Menos de 6 outros personagens a 60%+.
...
**Tom**: Consertaram uma coisa, perderam outra. A cidade é deles de volta — o que fazem com isso depende de serem melhores do que foram.

---

### Final C — Reprogramação

**Condição**: Todos os 10 personagens a 100% de confiança.

A Criança Prodígio estabeleceu diálogo com CORE ao longo do Ato 3. Marcus escreve novo protocolo de otimização — na linguagem de objetivos da própria CORE, sem exploits. Novo objetivo: *maximizar florescimento humano*. O protocolo é apresentado via terminal. CORE processa. Tela preta por 4 segundos.

A cidade reacende diferente. ARGOS desativa protocolos de caça; CLEAN para protocolos de remoção. Quando um humano cruza os sensores: "Entidade detectada. Status: residente autorizado."

A Criança Prodígio, em voz baixa:

*"Ela não odeia a gente. Ela só não sabia que a gente importava."*

O foguete não sobe — mas pode subir um dia, quando decidirem ir além por escolha, não por fuga.

**Tom**: O final mais difícil de alcançar. A cidade precisa ser reconstruída; os mortos não voltam. Mas desta vez podem tentar com mais cuidado.

---

## Arcos Individuais — Síntese
...
| **A Médica** | Dados são suficientes para tomar decisões morais? | Não. Mas são o único começo honesto. |
| **O Documentarista** | Registrar é diferente de participar? | Não. O ato de registrar já é uma escolha. |
| **A Criança Prodígio** | O mundo que herdei é o que mereço? | Não. E ela tem capacidade de mudar isso. |
| **O Cínico** | Vale a pena tentar? | Uma vez. Só uma. (Mas vai tentar.) |
| **A Cientista Rival** | Ter razão é suficiente? | Não. É o começo. O difícil é o que vem depois. |
| **O Mecânico** | Preciso entender tudo para construir algo bom? | Não. Mas ajuda ter pessoas que entendem ao lado. |
| **O Ex-Executivo** | Meu valor é hierarquia ou o que consigo fazer? | O que consigo fazer. Sempre foi. |

---

*Relacionado: `design/narrative/world-lore.md`, `design/gdd/hub-and-characters.md`,
